...
exports.sentinel = exports.ThreatLevel = void 0;
...
class SentinelService {
    joinCache = new Map(); // guildId -> timestamps
    messageCache = new Map(); // authorId -> timestamps
    async evaluateJoin(member) {
    ...
    async triggerRaidMitigation(guild) {
        ...
        // 2. Active Raid Event
        await db_1.prisma.raidEvent.create({
            data: {
                guildId: guild.id,
                status: 'ACTIVE'
            }
...
exports.sentinel = new SentinelService();
